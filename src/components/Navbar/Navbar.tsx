          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-4">
              {user?.isVerified || isResetPage ? (
                ...
                <Link
                  to="/verify-email"
                  className="text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full bg-error/20 text-error border border-error/20 hover:bg-error/30 transition-all"
                >
                  Weryfikacja Konta
                </Link>
              )}
